...
//
//		Employee newEmployee = Employee.builder().firstName("Admin").lastName("Admin").emailId("admin@gmail.com").build();
//
//		RestTemplate restTemplate = new RestTemplate();
...
//		Map<String, String> params = new HashMap<String, String>();
//		params.put("id", "1");
//		Employee updatedEmployee = Employee.builder().firstName("Admin").lastName("Admin").emailId("admin@gmail.com").build();
//		RestTemplate restTemplate = new RestTemplate();
